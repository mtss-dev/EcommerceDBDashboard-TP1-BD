...
def add_product(asin,title,product_group,sales_rank, assins_list,review_list):
...
if __name__ == '__main__':
    ...
    add_product('0738700797','Candlemas: Feast of Flames','Book',168596, similar_products,reviews)